...
class Decoder(nn.Module):
    def __init__(self, aspp_channels=256, low_channels=24, c3_channels=96,
    ...
    def forward(self, high_level, low_level, c3):
        ...
        # Third fusion H/4
        up_4 = F.interpolate(fused_16, size=low_level.shape[2:], mode='bilinear', align_corners=False)
